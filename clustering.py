...
def clustering_column(filename, exprs, cname='new', fout="result.csv"):
    """
    Function to clustering dataset with a specified expression
    Append new attr to end of dataset
    """
...
if (__name__ == '__main__'):
    ...
    clustering_column(args.files_in, args.exprs, args.cname, args.out)
